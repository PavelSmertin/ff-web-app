              ...
              <tr class="trader_ratings_row">
                <td>
                  ...
                  <div class="pie-wrapper progress-95 style-2">
                    <span class="label">{{ trader.rating_common ? trader.rating_common : 0 }}</span>
                    <div class="pie">
                ...
                <td>
                  ...
                  <div class="pie-wrapper progress-95 style-2">
                    <span class="label">{{ trader.rating_profit ? trader.rating_profit : 0 }}</span>
                    <div class="pie">
                      <div class="left-side half-circle"></div>
                      <div class="right-side half-circle"></div>
                    </div>
                ...
                <td>
                  ...
                  <div class="pie-wrapper progress-95 style-2">
                    <span class="label">{{ trader.rating_accuracy ? trader.rating_accuracy : 0 }}</span>
                    <div class="pie">
                      <div class="left-side half-circle"></div>
                      <div class="right-side half-circle"></div>
                    </div>
                ...
                <td>
                  ...
                  <div class="pie-wrapper progress-95 style-2">
                    <span class="label">{{ trader.rating_price ? trader.rating_price : 0 }}</span>
                    <div class="pie">
                      <div class="left-side half-circle"></div>
                      <div class="right-side half-circle"></div>
                    </div>
                ...
                <td>
                  ...
                  <div class="pie-wrapper progress-95 style-2">
                    <span class="label">{{ trader.rating_support ? trader.rating_support : 0 }}</span>
                    <div class="pie">
                      <div class="left-side half-circle"></div>
                      <div class="right-side half-circle"></div>
                    </div>
